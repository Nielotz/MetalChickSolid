...
class Graphic
{
	sf::Rect<int> ATTACK_BUTTON = sf::Rect<int>(CONSTS::TILE_SIZE, 14 * CONSTS::TILE_SIZE, 4 * CONSTS::TILE_SIZE, CONSTS::TILE_SIZE);
	sf::Rect<int> MAGIC_BUTTON = sf::Rect<int>(CONSTS::TILE_SIZE * 7, 14 * CONSTS::TILE_SIZE, 4 * CONSTS::TILE_SIZE, CONSTS::TILE_SIZE);
	sf::Rect<int> QUICK_HEAL_BUTTON = sf::Rect<int>(CONSTS::TILE_SIZE * 13, 14 * CONSTS::TILE_SIZE, 6 * CONSTS::TILE_SIZE, CONSTS::TILE_SIZE);

	sf::Rect<int> DEFENCE_BUTTON = sf::Rect<int>(CONSTS::TILE_SIZE, 16 * CONSTS::TILE_SIZE, 4 * CONSTS::TILE_SIZE, CONSTS::TILE_SIZE);
	sf::Rect<int> RUN_AWAY_BUTTON = sf::Rect<int>(CONSTS::TILE_SIZE * 7, 16 * CONSTS::TILE_SIZE, 4 * CONSTS::TILE_SIZE, CONSTS::TILE_SIZE);
	sf::Rect<int> SAVE_FIGHT_BUTTON = sf::Rect<int>(CONSTS::TILE_SIZE * 13, 16 * CONSTS::TILE_SIZE, 6 * CONSTS::TILE_SIZE, CONSTS::TILE_SIZE);
...
public:
	...
	ARENA_BUTTON check_arena_button_clicked(sf::Vector2i& mouse_click_pos);
